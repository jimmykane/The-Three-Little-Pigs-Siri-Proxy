...
def parse_options
  ...
  @option_parser = OptionParser.new do |opts|
    ...
    opts.on('-serv1', '--name SERVER1',  '[gencerts] Define a Server 1 for the CA (default: "kryten.apple.com")') do |server2|
      $APP_CONFIG.server1 = server1
    end 
    opts.on('-serv2', '--name SERVER2',  '[gencerts] Define a Server 2 for the CA (default: "your.siri.proxy.server.com")') do |server3|
